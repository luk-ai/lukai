...
public class ModelType {
  ...
  public static ModelType create(String domain, String modelType, String dataDir) throws Exception {
    return new ModelType(domain, modelType, dataDir);
  }
  ...
  private static void serializeTo(ByteArrayOutputStream w, String str) throws UnsupportedEncodingException {

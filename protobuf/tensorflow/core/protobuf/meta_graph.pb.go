...
// source: protobuf/tensorflow/core/protobuf/meta_graph.proto

/*
	Package tensorflow is a generated protocol buffer package.

	It is generated from these files:
		protobuf/tensorflow/core/protobuf/meta_graph.proto
...
import tensorflow7 "github.com/d4l3k/pok/tensorflow/core/framework"
...
import tensorflow11 "github.com/d4l3k/pok/tensorflow/core/protobuf"
...
type TensorInfo struct {
	...
	Dtype    tensorflow3.DataType  `protobuf:"varint,2,opt,name=dtype,proto3,enum=tensorflow.DataType" json:"dtype,omitempty"`
...
func (this *MetaGraphDef) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*MetaGraphDef)
	if !ok {
		that2, ok := that.(MetaGraphDef)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.MetaInfoDef.Equal(that1.MetaInfoDef) {
		return false
	}
	if !this.GraphDef.Equal(that1.GraphDef) {
		return false
	}
	if !this.SaverDef.Equal(that1.SaverDef) {
		return false
	}
	if len(this.CollectionDef) != len(that1.CollectionDef) {
		return false
	}
	for i := range this.CollectionDef {
		if !this.CollectionDef[i].Equal(that1.CollectionDef[i]) {
			return false
		}
	}
	if len(this.SignatureDef) != len(that1.SignatureDef) {
		return false
	}
	for i := range this.SignatureDef {
		if !this.SignatureDef[i].Equal(that1.SignatureDef[i]) {
			return false
		}
	}
	if len(this.AssetFileDef) != len(that1.AssetFileDef) {
		return false
	}
	for i := range this.AssetFileDef {
		if !this.AssetFileDef[i].Equal(that1.AssetFileDef[i]) {
			return false
		}
	}
	return true
}
func (this *MetaGraphDef_MetaInfoDef) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*MetaGraphDef_MetaInfoDef)
	if !ok {
		that2, ok := that.(MetaGraphDef_MetaInfoDef)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.MetaGraphVersion != that1.MetaGraphVersion {
		return false
	}
	if !this.StrippedOpList.Equal(that1.StrippedOpList) {
		return false
	}
	if !this.AnyInfo.Equal(that1.AnyInfo) {
		return false
	}
	...
	if this.TensorflowVersion != that1.TensorflowVersion {
		return false
	}
	if this.TensorflowGitVersion != that1.TensorflowGitVersion {
		return false
	}
	return true
}
func (this *CollectionDef) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*CollectionDef)
	if !ok {
		that2, ok := that.(CollectionDef)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CollectionDef_NodeList_) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*CollectionDef_NodeList_)
	if !ok {
		that2, ok := that.(CollectionDef_NodeList_)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CollectionDef_BytesList_) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*CollectionDef_BytesList_)
	if !ok {
		that2, ok := that.(CollectionDef_BytesList_)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CollectionDef_Int64List_) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*CollectionDef_Int64List_)
	if !ok {
		that2, ok := that.(CollectionDef_Int64List_)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CollectionDef_FloatList_) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*CollectionDef_FloatList_)
	if !ok {
		that2, ok := that.(CollectionDef_FloatList_)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CollectionDef_AnyList_) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*CollectionDef_AnyList_)
	if !ok {
		that2, ok := that.(CollectionDef_AnyList_)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.AnyList.Equal(that1.AnyList) {
		return false
	}
	return true
}
func (this *CollectionDef_NodeList) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*CollectionDef_NodeList)
	if !ok {
		that2, ok := that.(CollectionDef_NodeList)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CollectionDef_BytesList) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*CollectionDef_BytesList)
	if !ok {
		that2, ok := that.(CollectionDef_BytesList)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CollectionDef_Int64List) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*CollectionDef_Int64List)
	if !ok {
		that2, ok := that.(CollectionDef_Int64List)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CollectionDef_FloatList) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*CollectionDef_FloatList)
	if !ok {
		that2, ok := that.(CollectionDef_FloatList)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CollectionDef_AnyList) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*CollectionDef_AnyList)
	if !ok {
		that2, ok := that.(CollectionDef_AnyList)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *TensorInfo) Equal(that interface{}) bool {
	...
	if that1.Encoding == nil {
		if this.Encoding != nil {
			return false
		}
	} else if this.Encoding == nil {
		return false
	} else if !this.Encoding.Equal(that1.Encoding) {
		return false
	}
...
func (this *TensorInfo_Name) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*TensorInfo_Name)
	if !ok {
		that2, ok := that.(TensorInfo_Name)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *TensorInfo_CooSparse_) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*TensorInfo_CooSparse_)
	if !ok {
		that2, ok := that.(TensorInfo_CooSparse_)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.CooSparse.Equal(that1.CooSparse) {
		return false
	}
	return true
}
func (this *TensorInfo_CooSparse) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*TensorInfo_CooSparse)
	if !ok {
		that2, ok := that.(TensorInfo_CooSparse)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.ValuesTensorName != that1.ValuesTensorName {
		return false
	}
	if this.IndicesTensorName != that1.IndicesTensorName {
		return false
	}
	if this.DenseShapeTensorName != that1.DenseShapeTensorName {
		return false
	}
	return true
}
func (this *SignatureDef) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*SignatureDef)
	if !ok {
		that2, ok := that.(SignatureDef)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.MethodName != that1.MethodName {
		return false
	}
	return true
}
func (this *AssetFileDef) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*AssetFileDef)
	if !ok {
		that2, ok := that.(AssetFileDef)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.TensorInfo.Equal(that1.TensorInfo) {
		return false
	}
...
func (this *MetaGraphDef) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 10)
	s = append(s, "&tensorflow.MetaGraphDef{")
	if this.MetaInfoDef != nil {
		s = append(s, "MetaInfoDef: "+fmt.Sprintf("%#v", this.MetaInfoDef)+",\n")
	}
	if this.GraphDef != nil {
		s = append(s, "GraphDef: "+fmt.Sprintf("%#v", this.GraphDef)+",\n")
	}
	if this.SaverDef != nil {
		s = append(s, "SaverDef: "+fmt.Sprintf("%#v", this.SaverDef)+",\n")
	}
	keysForCollectionDef := make([]string, 0, len(this.CollectionDef))
	for k, _ := range this.CollectionDef {
		keysForCollectionDef = append(keysForCollectionDef, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForCollectionDef)
	mapStringForCollectionDef := "map[string]*CollectionDef{"
	for _, k := range keysForCollectionDef {
		mapStringForCollectionDef += fmt.Sprintf("%#v: %#v,", k, this.CollectionDef[k])
	}
	mapStringForCollectionDef += "}"
	if this.CollectionDef != nil {
		s = append(s, "CollectionDef: "+mapStringForCollectionDef+",\n")
	}
	keysForSignatureDef := make([]string, 0, len(this.SignatureDef))
	for k, _ := range this.SignatureDef {
		keysForSignatureDef = append(keysForSignatureDef, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForSignatureDef)
	mapStringForSignatureDef := "map[string]*SignatureDef{"
	for _, k := range keysForSignatureDef {
		mapStringForSignatureDef += fmt.Sprintf("%#v: %#v,", k, this.SignatureDef[k])
	}
	mapStringForSignatureDef += "}"
	if this.SignatureDef != nil {
		s = append(s, "SignatureDef: "+mapStringForSignatureDef+",\n")
	}
	if this.AssetFileDef != nil {
		s = append(s, "AssetFileDef: "+fmt.Sprintf("%#v", this.AssetFileDef)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *MetaGraphDef_MetaInfoDef) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 10)
	s = append(s, "&tensorflow.MetaGraphDef_MetaInfoDef{")
	s = append(s, "MetaGraphVersion: "+fmt.Sprintf("%#v", this.MetaGraphVersion)+",\n")
	if this.StrippedOpList != nil {
		s = append(s, "StrippedOpList: "+fmt.Sprintf("%#v", this.StrippedOpList)+",\n")
	}
	if this.AnyInfo != nil {
		s = append(s, "AnyInfo: "+fmt.Sprintf("%#v", this.AnyInfo)+",\n")
	}
	s = append(s, "Tags: "+fmt.Sprintf("%#v", this.Tags)+",\n")
	s = append(s, "TensorflowVersion: "+fmt.Sprintf("%#v", this.TensorflowVersion)+",\n")
	s = append(s, "TensorflowGitVersion: "+fmt.Sprintf("%#v", this.TensorflowGitVersion)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *CollectionDef) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 9)
	s = append(s, "&tensorflow.CollectionDef{")
	if this.Kind != nil {
...
func (this *CollectionDef_NodeList_) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&tensorflow.CollectionDef_NodeList_{` +
		`NodeList:` + fmt.Sprintf("%#v", this.NodeList) + `}`}, ", ")
	return s
}
func (this *CollectionDef_BytesList_) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&tensorflow.CollectionDef_BytesList_{` +
		`BytesList:` + fmt.Sprintf("%#v", this.BytesList) + `}`}, ", ")
	return s
}
func (this *CollectionDef_Int64List_) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&tensorflow.CollectionDef_Int64List_{` +
		`Int64List:` + fmt.Sprintf("%#v", this.Int64List) + `}`}, ", ")
	return s
}
func (this *CollectionDef_FloatList_) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&tensorflow.CollectionDef_FloatList_{` +
		`FloatList:` + fmt.Sprintf("%#v", this.FloatList) + `}`}, ", ")
	return s
}
func (this *CollectionDef_AnyList_) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&tensorflow.CollectionDef_AnyList_{` +
		`AnyList:` + fmt.Sprintf("%#v", this.AnyList) + `}`}, ", ")
	return s
}
func (this *CollectionDef_NodeList) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&tensorflow.CollectionDef_NodeList{")
	s = append(s, "Value: "+fmt.Sprintf("%#v", this.Value)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *CollectionDef_BytesList) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&tensorflow.CollectionDef_BytesList{")
	s = append(s, "Value: "+fmt.Sprintf("%#v", this.Value)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *CollectionDef_Int64List) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&tensorflow.CollectionDef_Int64List{")
	s = append(s, "Value: "+fmt.Sprintf("%#v", this.Value)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *CollectionDef_FloatList) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&tensorflow.CollectionDef_FloatList{")
	s = append(s, "Value: "+fmt.Sprintf("%#v", this.Value)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *CollectionDef_AnyList) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&tensorflow.CollectionDef_AnyList{")
	if this.Value != nil {
		s = append(s, "Value: "+fmt.Sprintf("%#v", this.Value)+",\n")
	}
	s = append(s, "}")
...
func (this *TensorInfo) GoString() string {
	...
	s := make([]string, 0, 8)
	s = append(s, "&tensorflow.TensorInfo{")
	if this.Encoding != nil {
...
func (this *TensorInfo_Name) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&tensorflow.TensorInfo_Name{` +
		`Name:` + fmt.Sprintf("%#v", this.Name) + `}`}, ", ")
	return s
}
func (this *TensorInfo_CooSparse_) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&tensorflow.TensorInfo_CooSparse_{` +
		`CooSparse:` + fmt.Sprintf("%#v", this.CooSparse) + `}`}, ", ")
	return s
}
func (this *TensorInfo_CooSparse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&tensorflow.TensorInfo_CooSparse{")
	s = append(s, "ValuesTensorName: "+fmt.Sprintf("%#v", this.ValuesTensorName)+",\n")
	s = append(s, "IndicesTensorName: "+fmt.Sprintf("%#v", this.IndicesTensorName)+",\n")
	s = append(s, "DenseShapeTensorName: "+fmt.Sprintf("%#v", this.DenseShapeTensorName)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *SignatureDef) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&tensorflow.SignatureDef{")
	...
	mapStringForInputs := "map[string]*TensorInfo{"
...
func (this *AssetFileDef) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&tensorflow.AssetFileDef{")
	if this.TensorInfo != nil {
		s = append(s, "TensorInfo: "+fmt.Sprintf("%#v", this.TensorInfo)+",\n")
	}
	s = append(s, "Filename: "+fmt.Sprintf("%#v", this.Filename)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func valueToGoStringMetaGraph(v interface{}, typ string) string {
...
func (this *MetaGraphDef) String() string {
	if this == nil {
		return "nil"
	}
	keysForCollectionDef := make([]string, 0, len(this.CollectionDef))
	...
	mapStringForSignatureDef += "}"
	s := strings.Join([]string{`&MetaGraphDef{`,
		`MetaInfoDef:` + strings.Replace(fmt.Sprintf("%v", this.MetaInfoDef), "MetaGraphDef_MetaInfoDef", "MetaGraphDef_MetaInfoDef", 1) + `,`,
		`GraphDef:` + strings.Replace(fmt.Sprintf("%v", this.GraphDef), "GraphDef", "tensorflow10.GraphDef", 1) + `,`,
		`SaverDef:` + strings.Replace(fmt.Sprintf("%v", this.SaverDef), "SaverDef", "tensorflow11.SaverDef", 1) + `,`,
		`CollectionDef:` + mapStringForCollectionDef + `,`,
		`SignatureDef:` + mapStringForSignatureDef + `,`,
		`AssetFileDef:` + strings.Replace(fmt.Sprintf("%v", this.AssetFileDef), "AssetFileDef", "AssetFileDef", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *MetaGraphDef_MetaInfoDef) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&MetaGraphDef_MetaInfoDef{`,
		`MetaGraphVersion:` + fmt.Sprintf("%v", this.MetaGraphVersion) + `,`,
		`StrippedOpList:` + strings.Replace(fmt.Sprintf("%v", this.StrippedOpList), "OpList", "tensorflow7.OpList", 1) + `,`,
		`AnyInfo:` + strings.Replace(fmt.Sprintf("%v", this.AnyInfo), "Any", "google_protobuf.Any", 1) + `,`,
		`Tags:` + fmt.Sprintf("%v", this.Tags) + `,`,
		`TensorflowVersion:` + fmt.Sprintf("%v", this.TensorflowVersion) + `,`,
		`TensorflowGitVersion:` + fmt.Sprintf("%v", this.TensorflowGitVersion) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CollectionDef) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CollectionDef{`,
		`Kind:` + fmt.Sprintf("%v", this.Kind) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CollectionDef_NodeList_) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CollectionDef_NodeList_{`,
		`NodeList:` + strings.Replace(fmt.Sprintf("%v", this.NodeList), "CollectionDef_NodeList", "CollectionDef_NodeList", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CollectionDef_BytesList_) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CollectionDef_BytesList_{`,
		`BytesList:` + strings.Replace(fmt.Sprintf("%v", this.BytesList), "CollectionDef_BytesList", "CollectionDef_BytesList", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CollectionDef_Int64List_) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CollectionDef_Int64List_{`,
		`Int64List:` + strings.Replace(fmt.Sprintf("%v", this.Int64List), "CollectionDef_Int64List", "CollectionDef_Int64List", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CollectionDef_FloatList_) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CollectionDef_FloatList_{`,
		`FloatList:` + strings.Replace(fmt.Sprintf("%v", this.FloatList), "CollectionDef_FloatList", "CollectionDef_FloatList", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CollectionDef_AnyList_) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CollectionDef_AnyList_{`,
		`AnyList:` + strings.Replace(fmt.Sprintf("%v", this.AnyList), "CollectionDef_AnyList", "CollectionDef_AnyList", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CollectionDef_NodeList) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CollectionDef_NodeList{`,
		`Value:` + fmt.Sprintf("%v", this.Value) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CollectionDef_BytesList) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CollectionDef_BytesList{`,
		`Value:` + fmt.Sprintf("%v", this.Value) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CollectionDef_Int64List) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CollectionDef_Int64List{`,
		`Value:` + fmt.Sprintf("%v", this.Value) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CollectionDef_FloatList) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CollectionDef_FloatList{`,
		`Value:` + fmt.Sprintf("%v", this.Value) + `,`,
		`}`,
	}, "")
	return s
}
func (this *CollectionDef_AnyList) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CollectionDef_AnyList{`,
...
func (this *TensorInfo_Name) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&TensorInfo_Name{`,
		`Name:` + fmt.Sprintf("%v", this.Name) + `,`,
		`}`,
	}, "")
	return s
}
func (this *TensorInfo_CooSparse_) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&TensorInfo_CooSparse_{`,
		`CooSparse:` + strings.Replace(fmt.Sprintf("%v", this.CooSparse), "TensorInfo_CooSparse", "TensorInfo_CooSparse", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *TensorInfo_CooSparse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&TensorInfo_CooSparse{`,
		`ValuesTensorName:` + fmt.Sprintf("%v", this.ValuesTensorName) + `,`,
		`IndicesTensorName:` + fmt.Sprintf("%v", this.IndicesTensorName) + `,`,
		`DenseShapeTensorName:` + fmt.Sprintf("%v", this.DenseShapeTensorName) + `,`,
		`}`,
	}, "")
	return s
}
func (this *SignatureDef) String() string {
	if this == nil {
		return "nil"
	}
	keysForInputs := make([]string, 0, len(this.Inputs))
	...
	mapStringForOutputs += "}"
	s := strings.Join([]string{`&SignatureDef{`,
...
func (this *AssetFileDef) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AssetFileDef{`,
		`TensorInfo:` + strings.Replace(fmt.Sprintf("%v", this.TensorInfo), "TensorInfo", "TensorInfo", 1) + `,`,
		`Filename:` + fmt.Sprintf("%v", this.Filename) + `,`,
		`}`,
	}, "")
	return s
}
func valueToStringMetaGraph(v interface{}) string {
	rv := reflect.ValueOf(v)
	if rv.IsNil() {
		return "nil"
	}
...
func (m *MetaGraphDef) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.SaverDef == nil {
				m.SaverDef = &tensorflow11.SaverDef{}
			}
...
func init() {
	proto.RegisterFile("protobuf/tensorflow/core/protobuf/meta_graph.proto", fileDescriptorMetaGraph)
}
...
var fileDescriptorMetaGraph = []byte{
	...
	,
}

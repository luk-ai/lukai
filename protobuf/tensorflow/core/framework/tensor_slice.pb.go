...
// source: protobuf/tensorflow/core/framework/tensor_slice.proto

/*
	Package tensorflow is a generated protocol buffer package.

	It is generated from these files:
		protobuf/tensorflow/core/framework/tensor_slice.proto
...
func (this *TensorSliceProto) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&tensorflow.TensorSliceProto{")
	if this.Extent != nil {
...
func (this *TensorSliceProto_Extent) GoString() string {
	...
	s := make([]string, 0, 6)
	s = append(s, "&tensorflow.TensorSliceProto_Extent{")
...
func (this *TensorSliceProto_Extent_Length) GoString() string {
	...
	s := strings.Join([]string{`&tensorflow.TensorSliceProto_Extent_Length{` +
...
func init() {
	proto.RegisterFile("protobuf/tensorflow/core/framework/tensor_slice.proto", fileDescriptorTensorSlice)
}
...
var fileDescriptorTensorSlice = []byte{
	...
	0xc4, 0x17, 0xe7, 0x64, 0x26, 0xa7, 0xea, 0x81, 0xd5, 0x0b, 0x71, 0x21, 0x54, 0x2b, 0x4d, 0x67,
	0xe4, 0x12, 0x08, 0x01, 0x73, 0x83, 0x41, 0x2a, 0x02, 0xc0, 0x0a, 0xac, 0xb9, 0xd8, 0x52, 0x2b,
	0x4a, 0x52, 0xf3, 0x4a, 0x24, 0x18, 0x15, 0x98, 0x35, 0xb8, 0x8d, 0x94, 0xf5, 0x10, 0x3a, 0xf4,
	0xd0, 0x55, 0xeb, 0xb9, 0x82, 0x95, 0x06, 0x41, 0xb5, 0x48, 0xb9, 0x71, 0xb1, 0x41, 0x44, 0x84,
	0x44, 0xb8, 0x58, 0x8b, 0x4b, 0x12, 0x8b, 0x40, 0xa6, 0x30, 0x6a, 0x30, 0x07, 0x41, 0x38, 0x42,
	0x12, 0x5c, 0x6c, 0x39, 0xa9, 0x79, 0xe9, 0x25, 0x19, 0x12, 0x4c, 0x20, 0x61, 0x0f, 0x86, 0x20,
	0x28, 0xdf, 0x89, 0x87, 0x8b, 0x2b, 0x23, 0xb1, 0x38, 0x1e, 0xca, 0x8b, 0xbb, 0xf0, 0x50, 0x8e,
	...
	0x24, 0xc7, 0xf0, 0xe1, 0x91, 0x1c, 0xe3, 0x84, 0xc7, 0x72, 0x0c, 0x5c, 0x12, 0xf9, 0x45, 0xe9,
	0xc8, 0xae, 0x84, 0x07, 0x80, 0x93, 0x20, 0xba, 0x83, 0x8b, 0x03, 0x18, 0x7f, 0x30, 0x32, 0x26,
	0xb1, 0x81, 0x03, 0xc3, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xc9, 0xbf, 0xfa, 0xf4, 0x45, 0x01,
	0x00, 0x00,
}

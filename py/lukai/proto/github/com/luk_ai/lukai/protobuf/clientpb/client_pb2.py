...
# source: github.com/luk-ai/lukai/protobuf/clientpb/client.proto
...
_MODELMETA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\310\336\037\000\202\337\037\005Event')), file=DESCRIPTOR),
  ],
  extensions=[
  ],
...
ExampleFile = _reflection.GeneratedProtocolMessageType('ExampleFile', (_message.Message,), dict(
  ...
  __module__ = 'github.com.luk_ai.lukai.protobuf.clientpb.client_pb2'

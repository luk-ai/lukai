...
python_proto_dir =py/lukai/proto/
...
.PHONY: loc
loc:
	cloc --3 $(shell find . -type f | sed '/_pb2/d' | sed '/.pb.go/d' | sed '/proto\/tensorflow/d' | sed '/.git/d' | sed '/__pycache__/d' | sed '/.egg-info/d' | sed '/testdata/d' | sed '/py\/build/d' | sed '/py\/dist/d' | sed '/android/d')
